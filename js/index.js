    ...
    var vm = new Vue({
        ...
        methods: {
            appendDialog: function appendDialog(id) {
                ...
                getRandomMsg(dialog.details).forEach(function (content) {
                    _this2.msgChain = _this2.msgChain.then(function () {
                        ...
                        return _this2.sendMsg(content, AUTHOR.LEI);
                    });
                });

                return dialog.nextLeiResp ? this.appendDialog(dialog.nextLeiResp) : this.msgChain.then(function () {
                    _this2.lastDialog = dialog;
                    _this2.isLeiTyping = false;
                });
            },
            ...
            getDialog: function getDialog(id) {
                ...
                var dialogs = this.dialogs.fromLei.filter(function (dialog) {
                    return dialog.id === id;
                });
            ...
            respond: function respond(response) {
                ...
                return this.say(response.content, response.nextLeiResp);
            },
            ask: function ask(fromUser) {
                ...
                return this.say(content, fromUser.nextLeiResp);
            },
