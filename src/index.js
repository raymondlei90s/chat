    ...
    const vm = new Vue({
        ...
        methods: {
                ...
                getRandomMsg(dialog.details)
                    .forEach(content => {
                        this.msgChain = this.msgChain
                            .then(() => delay(700))
                            .then(() => this.sendMsg(content, AUTHOR.LEI));
                    });

                return dialog.nextLeiResp
                    ? this.appendDialog(dialog.nextLeiResp)
                    : this.msgChain.then(() => {
                        this.lastDialog = dialog;
                        this.isLeiTyping = false;
                    });
            },
            ...
            getDialog(id) {
                ...
                const dialogs = this.dialogs.fromLei
